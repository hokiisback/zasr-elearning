...
function default_parser_item($add_item = array())
{
    ...
    $return = array(
        'base_url'          => base_url(),
        'site_url'          => site_url(),
        'favicon_url'       => base_url('assets/images/ico.ico'),
    ...
    if ($CI->uri->segment(1) != 'setup') {
        $return['copyright'] = 'Copyright &copy; ' . date('Y') . ' <span style="color: #3489DB;">' . get_pengaturan('nama-sekolah', 'value') .'</span> ZASR Indonesia';
